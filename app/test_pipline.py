...
from main import process_image, FILE_DICT, RESULT_FILES
...
def test_process_image():
    ...
    assert os.path.isfile(example_image_path), f"Test image missing: {example_image_path}"
    ...
    assert os.path.exists(processed_img_path), f"Processed image not found: {processed_img_path}"
